...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(DioExceptions error, StackTrace stackTrace)
        failure,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(DioExceptions error, StackTrace stackTrace)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({DioExceptions error, StackTrace stackTrace});
}
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(
          final DioExceptions error, final StackTrace stackTrace) =
      _$FailureImpl<T>;
